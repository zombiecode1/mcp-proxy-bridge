...
const REPORT_PATH = path.resolve(process.cwd(), 'test', 'mcp-status-report.json');
const DB_PATH = path.resolve(process.cwd(), '.zombiecoder', 'state.db');
const DOC_DIR = path.resolve(process.cwd(), 'documentation', 'agent-proof');
