...
async function testAutoConnectedServer() {
    const testResults = {
        serverName: "Auto-connected Server",
    ...
    try {
        ...
        console.log("Testing Auto-connected Server");
        ...
        const session = client.getSession("auto_connected");
...
export { testAutoConnectedServer };

// Run the test if called directly
testAutoConnectedServer().catch(console.error);
