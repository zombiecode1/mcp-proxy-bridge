...
async function testProxyBridgeServer() {
    const testResults = {
        serverName: "Proxy Bridge",
        serverUrl: "https://zombiecoder.my.id/sse",
    ...
    try {
        ...
        console.log("Testing Proxy Bridge Server");
        console.log("URL: https://zombiecoder.my.id/sse");
        console.log("=".repeat(60));
        ...
        const session = client.getSession("proxy_bridge");
...
export { testProxyBridgeServer };

// Run the test if called directly
testProxyBridgeServer().catch(console.error);
